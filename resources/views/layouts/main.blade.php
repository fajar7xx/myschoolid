...
<head>
    ...
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="{{ asset('admin/html/assets/css/site.min.css') }}">
...
<body class="theme-cyan font-montserrat light_version">
    ...
    <div id="wrapper">
                    ...
                    <div class="tab-pane vivify fadeIn delay-100 active" id="Chat-one">
                        <div class="chat_detail">
                            <ul class="chat-widget clearfix">
                                ...
                                <li class="right">
                                    <img src="{{ asset('admin/assets/images/xs/avatar1.jpg') }}" class="rounded" alt="">
                                    <div class="chat-info">
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="navbar-brand">
                <a href="index.html"><img src="{{ asset('admin/assets/images/icon.svg') }}" alt="Oculux Logo"
            ...
            <div class="sidebar-scroll">
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="active open"><a href="index.html"><i class="icon-speedometer"></i><span>HR
                                    Dashboard</span></a></li>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 col-sm-12 text-right hidden-xs">
                            ...
                            <a href="https://themeforest.net/item/oculux-bootstrap-4x-admin-dashboard-clean-modern-ui-kit/23091507"
                                class="btn btn-sm btn-success" title="Themeforest"><i class="icon-basket"></i> Buy
                                Now</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div id="slider2" class="carousel vert slide" data-ride="carousel" data-interval="1700">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="card-value float-right text-muted"><i class="wi wi-fog"></i>
                                            </div>
                                            <h3 class="mb-1">12°C</h3>
                                            <div>London</div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="card-value float-right text-muted"><i
                                                    class="wi wi-day-cloudy"></i></div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="w60">
                                                ...
                                                <div class="avtar-pic w35 bg-red" data-toggle="tooltip"
                                                    data-placement="top" title="Avatar Name"><span>MN</span></div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="w60">
                                                ...
                                                <div class="avtar-pic w35 bg-pink" data-toggle="tooltip"
                                                    data-placement="top" title="Avatar Name"><span>MN</span></div>
                                            </td>
                                            <td>
    ...
    <!-- Javascript -->
    <script src="{{ asset('admin/html/assets/bundles/libscripts.bundle.js') }}"></script>
    <script src="{{ asset('admin/html/assets/bundles/vendorscripts.bundle.js') }}"></script>

    <script src="{{ asset('admin/html/assets/bundles/c3.bundle.js') }}"></script>
    <script src="{{ asset('admin/html/assets/bundles/flotscripts.bundle.js') }}"></script>
    <script src="{{ asset('admin/html/assets/bundles/jvectormap.bundle.js') }}"></script>
    <script src="{{ asset('admin/assets/vendor/jvectormap/jquery-jvectormap-us-aea-en.js') }}"></script>

    <script src="{{ asset('admin/html/assets/bundles/mainscripts.bundle.js') }}"></script>
    <script src="{{ asset('admin/html/assets/js/hrdashboard.js') }}"></script>
</body>
